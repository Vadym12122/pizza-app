...
export function PageNotFound() {
    ...
    useEffect(() => {
        ...
        function calculateOffset(offset: number, sensitivity: number) {
        ...
        function movePupil(
            ...
            const maxRadius =
                Math.min(boundingRect.width, boundingRect.height) / 4;
        ...
        if (face && nose && head && leftPupil && rightPupil) {
            ...
            return () => {
                face.removeEventListener("mouseenter", handleMouseEnter);
    ...
    return (
        <>
            <div className={styles.main}>
                ...
                <div className={styles.main__404}>404</div>
                <div className={styles.main__title} onClick={goToHomePage}>
                    Перейти на головну
                </div>
            </div>
        </>
